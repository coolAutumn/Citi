...
public class NewsList {
	...
	public NewsList(String a) {
		this.code=a;
	}

	public NewsList(String code,int limit_day) {
		this.code = code;
	...
	public ArrayList<Announcement> init() {
		try {
			...
			ResultSet resultSet = statement
					.executeQuery("select * from news where code='" + code + "' order by ptime desc;");
			Date now = new Date();
	...
	public static void main(String[] args) {
		NewsList announcementList= new NewsList("600418");
